...
class DashboardApp(ctk.CTk):
    ...
    def scan_codes(self):
        ...
        self.ui_diagnostics.app.txt_dtc.delete("1.0", "end")
        if not codes:
            self.ui_diagnostics.app.txt_dtc.insert("end", translate("ui_main_window_diagnostics_no_faults"))
        else:
            self.ui_diagnostics.app.txt_dtc.insert("end", translate("ui_main_window_diagnostics_found_faults").format(len(codes)), "bold")
            for c in codes:
    ...
    def confirm_clear_codes(self):
        if not self.obd.is_connected(): messagebox.showerror(translate("ui_main_window_clear_codes_error_title"), translate("ui_main_window_clear_codes_error_not_connected")); return
        ...
        if answer:
            ...
            if self.obd.clear_dtc():
                ...
                messagebox.showinfo(translate("ui_main_window_clear_codes_success_title"), translate("ui_main_window_clear_codes_success_message"))
            else:
                if hasattr(self.ui_diagnostics.app, 'txt_dtc'):
